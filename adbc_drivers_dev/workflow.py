...
def main():
    ...
    test = template.render(**test_params)
    sink = args.repository / ".github/workflows/go_test.yaml"
    ...
    release = template.render(**release_params)
    sink = args.repository / ".github/workflows/go_release.yaml"
    with sink.open("w") as f:
        f.write(release)
    print("Wrote", sink)
